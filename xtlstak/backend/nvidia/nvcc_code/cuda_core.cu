...
#include "xtlstak/backend/nvidia/nvcc_code/cuda_fast_int_math_v2.hpp"
#include "xtlstak/backend/nvidia/nvcc_code/cuda_fast_div_heavy.hpp"
 ...
 */
template<size_t ITERATIONS, uint32_t MEMORY, uint32_t MASK, xtlstak_algo ALGO, uint32_t MEM_MODE>
...
template<size_t ITERATIONS, uint32_t MEMORY, uint32_t MASK, xtlstak_algo ALGO>
#ifdef XMR_STAK_THREADS
...
template<size_t ITERATIONS, uint32_t MEMORY, xtlstak_algo ALGO>
...
template<size_t ITERATIONS, uint32_t MASK, uint32_t MEMORY, xtlstak_algo ALGO, uint32_t MEM_MODE>
...
void cryptonight_core_cpu_hash(nvid_ctx* ctx, xtlstak_algo miner_algo, uint32_t startNonce)
{
