...
public:
	...
	static cn_hash_fun func_selector(bool bHaveAes, bool bNoPrefetch, xtlstak_algo algo);
...
private:
	...
	template<size_t N>
	static cn_hash_fun func_multi_selector(bool bHaveAes, bool bNoPrefetch, xtlstak_algo algo, const std::string& asm_version_str = "off");
