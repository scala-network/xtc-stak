...
#include "xtcstak/misc/coinDescription.hpp"
#include "params.hpp"
...
public:
	static jconf* inst()
	{
		auto& env = xtcstak::environment::inst();
	...
	inline xtcstak::coin_selection GetCurrentCoinSelection() const { return currentCoin; }
...
private:
	...
	bool bHaveAes;
	xtcstak::coin_selection currentCoin;
};
