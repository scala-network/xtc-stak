...
enum xtcstak_algo
{
	...
	cryptonight_torque = 7, //equal to cryptonight_monero but with one tiny change
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_torque>() { return CRYPTONIGHT_MEMORY; }
...
inline size_t cn_select_memory(xtcstak_algo algo)
{
	switch(algo)
	{
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_torque>() { return CRYPTONIGHT_MASK; }
...
inline size_t cn_select_mask(xtcstak_algo algo)
{
	switch(algo)
	{
	case cryptonight_torque:
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_monero>() { return CRYPTONIGHT_LITE_ITER; }

template<>
inline constexpr uint32_t cn_select_iter<cryptonight_monero_v8>() { return CRYPTONIGHT_LITE_ITER; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_torque>() { return CRYPTONIGHT_ITER; }
...
inline size_t cn_select_iter(xtcstak_algo algo)
{
	switch(algo)
	{
	case cryptonight_torque:
