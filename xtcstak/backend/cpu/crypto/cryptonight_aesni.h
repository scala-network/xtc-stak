...
template<size_t MEM, bool SOFT_AES, bool PREFETCH, xtcstak_algo ALGO>
...
#define CN_INIT_SINGLE \
	if((ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_ipbc || ALGO == cryptonight_torque || ALGO == cryptonight_masari || ALGO == cryptonight_bittube2) && len < 43) \
	{ \
...
struct Cryptonight_hash<1>
{
	...
	template<xtcstak_algo ALGO, bool SOFT_AES, bool PREFETCH>
