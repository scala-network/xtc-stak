...
#include "xtcstak/backend/nvidia/nvcc_code/cuda_fast_int_math_v2.hpp"
#include "xtcstak/backend/nvidia/nvcc_code/cuda_fast_div_heavy.hpp"
 ...
 */
template<size_t ITERATIONS, uint32_t MEMORY, uint32_t MASK, xtcstak_algo ALGO, uint32_t MEM_MODE>
...
template<size_t ITERATIONS, uint32_t MEMORY, uint32_t MASK, xtcstak_algo ALGO>
#ifdef XMR_STAK_THREADS
		...
		uint32_t startNonce, uint32_t * __restrict__ d_input )
{
	...
	uint32_t tweak1_2[2];
	if (ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_ipbc || ALGO == cryptonight_torque || ALGO == cryptonight_masari || ALGO == cryptonight_bittube2)
	{
...
template<size_t ITERATIONS, uint32_t MEMORY, xtcstak_algo ALGO>
...
template<size_t ITERATIONS, uint32_t MASK, uint32_t MEMORY, xtcstak_algo ALGO, uint32_t MEM_MODE>
...
void cryptonight_core_cpu_hash(nvid_ctx* ctx, xtcstak_algo miner_algo, uint32_t startNonce)
{
	...
	static const cuda_hash_fn func_table[] = {
		...
		cryptonight_core_gpu_hash<CRYPTONIGHT_ITER, CRYPTONIGHT_MASK, CRYPTONIGHT_MEMORY/4, cryptonight_torque, 0>,
		cryptonight_core_gpu_hash<CRYPTONIGHT_ITER, CRYPTONIGHT_MASK, CRYPTONIGHT_MEMORY/4, cryptonight_torque, 1>,
		...
		cryptonight_core_gpu_hash<CRYPTONIGHT_LITE_ITER, CRYPTONIGHT_MASK, CRYPTONIGHT_MEMORY/4, cryptonight_monero_v8, 0>,
		cryptonight_core_gpu_hash<CRYPTONIGHT_LITE_ITER, CRYPTONIGHT_MASK, CRYPTONIGHT_MEMORY/4, cryptonight_monero_v8, 1>,
