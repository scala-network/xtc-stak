...
inline size_t cn_select_memory(xtlstak_algo algo)
{
	switch(algo)
	{
...
inline size_t cn_select_mask(xtlstak_algo algo)
{
	switch(algo)
	{
	case cryptonight_stellite:
...
inline size_t cn_select_iter(xtlstak_algo algo)
{
	switch(algo)
	{
	case cryptonight_stellite:
