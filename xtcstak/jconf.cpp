...
xtcstak::coin_selection coins[] = {
	...
	{ "cryptonight_v7_torque", {cryptonight_monero_v8, cryptonight_torque, 255u}, {cryptonight_monero_v8, cryptonight_monero_v8, 0u}, nullptr },
	...
	{ "torque",            {cryptonight_monero_v8, cryptonight_torque, 9u}, {cryptonight_monero_v8, cryptonight_monero_v8, 0u}, nullptr },
...
{
	if(xtcstak::params::inst().httpd_port == xtcstak::params::httpd_port_unset)
		return prv->configValues[iHttpdPort]->GetUint();
	else
		return uint16_t(xtcstak::params::inst().httpd_port);
}
...
{
	if(xtcstak::params::inst().currency.length() > 0)
		return xtcstak::params::inst().currency;
	else
