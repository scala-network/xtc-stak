...
#include "xtcstak/backend/cpu/crypto/cryptonight_aesni.h"
...
#include "xtcstak/backend/cpu/hwlocMemory.hpp"
...
#endif
std::vector<iBackend*>* xtcstak_start_backend(uint32_t threadOffset, miner_work& pWork, environment& env)
{
