...
#include "xtlstak/misc/coinDescription.hpp"
#include "params.hpp"
...
public:
	...
	inline xtlstak::coin_selection GetCurrentCoinSelection() const { return currentCoin; }
...
private:
	...
	bool bHaveAes;
	xtlstak::coin_selection currentCoin;
};
